...
import { TestWidgetProps, TestWidget } from "./test-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/test-widget.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <test-widget message="world!"></test-widget>
   */
  return class TestWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): TestWidgetProps {
      const attrs = this.parseAttributes<TestWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<TestWidget {...this.props} />, container);
    }
